alert(
  "WARNING: This page contains contents that may be TOO STINKIN COOL for human viewing. Proceed with CAUTION"
);
// Selectors
...
function updateProgress() {
  ...
  // Use above information to compute the progress of the video in terms of percentage and log that percentage value to the console.
